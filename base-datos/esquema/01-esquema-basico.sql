...
CREATE TABLE ciudades (
    ...
    bounds JSONB, -- En lugar de GEOMETRY(POLYGON, 4326)
...
-- Tabla de puntos de venta (tenderos) - SIN PostGIS
CREATE TABLE tenderos (
    ...
    telefono VARCHAR(20),
    email VARCHAR(100),
    latitud DECIMAL(10,6), -- En lugar de GEOMETRY(POINT, 4326)
...
-- Tabla de visitas de vendedores - SIN PostGIS
CREATE TABLE visitas_vendedor (
    ...
    hora_entrada TIME,
    hora_salida TIME,
    latitud_visita DECIMAL(10,6), -- En lugar de GEOMETRY(POINT, 4326)
